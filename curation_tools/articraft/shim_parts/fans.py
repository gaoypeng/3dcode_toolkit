from articraft_cq import cq, MeshGeometry, _to_shape, _EPS

# ===========================================================================
# @section geom-fans   (FanRotorGeometry / BlowerWheelGeometry + specs)
#
# Clean-room CadQuery B-rep reimplementation of the Articraft sdk fan/rotor
# family. Constructor signatures mirror the real sdk exactly; the produced
# shapes are parametric solids (the sdk itself builds these with cadquery and
# then tessellates -- here we keep the B-rep).
# ===========================================================================
...
def _fans_shift_to_z0(solid):
    """Place the rear-most face on z=0 (sdk center=False behaviour)."""
    bb = solid.BoundingBox()
    return solid.translate(cq.Vector(0.0, 0.0, -bb.zmin))


# ---- sub-feature specs (frozen dataclasses, verbatim sdk signatures) -------
...
class BlowerWheelGeometry(MeshGeometry):
    ...
    def __init__(
        ...
        *,
        ...
        def annulus_point(radius: float, angle_rad: float) -> tuple:
